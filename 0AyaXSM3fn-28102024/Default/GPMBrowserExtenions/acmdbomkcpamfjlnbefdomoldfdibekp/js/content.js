(function () {
            ...
            (f.bindEvent = function (e, t, r) {
              ...
              if (t.existing) {
                for (var a = [], s = 0; s < o.length; s++)
                  for (
                    var u = o[s].querySelectorAll(e), f = 0;
                    f < u.length;
                    f++
                  )
  ...
  function modifyIframe() {
    document.querySelectorAll("iframe").forEach((iframe) => {
      ...
      if (
        src &&
        src.includes("tgWebAppPlatform=web") &&
        !src.includes("cats") &&
        !src.includes("wallet") &&
        !src.includes("bird") &&
        !src.includes("frogs") &&
        ...
        src = src.replace("tgWebAppPlatform=webk", "tgWebAppPlatform=android");
        src = src.replace("tgWebAppPlatform=webz", "tgWebAppPlatform=android");
        src = src.replace("tgWebAppPlatform=web", "tgWebAppPlatform=android");

        src = src.replace(/tgWebAppVersion=[0-9.]+/g, "tgWebAppVersion=8.0"); //Cho Not Pixel
